...
(function () {
  ...
  const EXACT = {
    fr: {
      ...
      'Free for tenants · Swiss data hosting · GDPR compliant': 'Gratuit pour les locataires · Hébergement suisse · Conforme RGPD',
      ...
      'Passport, salary slips, Betreibungsauszug. Our AI verifies and extracts the data automatically.': 'Passeport, fiches de salaire, attestation de non-poursuite. Notre IA vérifie et extrait les données automatiquement.',
      ...
      'Excellent': 'Excellent',
      'All documents verified, clean Betreibungsauszug, income ≥ 3× rent. Strongest possible profile.': 'Tous les documents vérifiés, attestation de non-poursuite nette, revenu ≥ 3× le loyer. Profil le plus solide.',
      'Good': 'Bon',
