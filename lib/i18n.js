// ============================================================
// SwissTrust — lightweight runtime i18n
// Supports English, French, German, Italian.
// ============================================================

(function () {
  const STORAGE_KEY = 'swisstrust:lang';
  ...
  const EXACT = {
    fr: {
      'SwissTrust — Verified Tenant Dossiers': 'SwissTrust — Dossiers locataires vérifiés',
      'Verify a certificate — SwissTrust': 'Vérifier un certificat — SwissTrust',
      'Sign in — SwissTrust': 'Connexion — SwissTrust',
      'Agency Dashboard — SwissTrust': 'Tableau de bord régie — SwissTrust',
      'Owner Dashboard — SwissTrust': 'Tableau de bord propriétaire — SwissTrust',
    ...
    de: {
      'SwissTrust — Verified Tenant Dossiers': 'SwissTrust — Verifizierte Mieterdossiers',
      'Verify a certificate — SwissTrust': 'Zertifikat prüfen — SwissTrust',
      'Sign in — SwissTrust': 'Anmelden — SwissTrust',
      'Agency Dashboard — SwissTrust': 'Verwaltungs-Dashboard — SwissTrust',
      'Owner Dashboard — SwissTrust': 'Eigentümer-Dashboard — SwissTrust',
    ...
    it: {
      'SwissTrust — Verified Tenant Dossiers': 'SwissTrust — Dossier locatari verificati',
      'Verify a certificate — SwissTrust': 'Verifica un certificato — SwissTrust',
      'Sign in — SwissTrust': 'Accedi — SwissTrust',
      'Agency Dashboard — SwissTrust': 'Dashboard agenzia — SwissTrust',
      'Owner Dashboard — SwissTrust': 'Dashboard proprietario — SwissTrust',
  ...
  const TEMPLATES = {
    ...
    fr: {
      ...
      agency_dashboard_subtitle: 'Locataires ayant dirigé leur certificat SwissTrust vers {agencyName}.',
    ...
    de: {
      ...
      agency_dashboard_subtitle: 'Mieter, die ihr SwissTrust-Zertifikat an {agencyName} gerichtet haben.',
    ...
    it: {
      ...
      agency_dashboard_subtitle: 'Locatari che hanno indirizzato il loro certificato SwissTrust a {agencyName}.',
  ...
  const PATTERNS = {
    fr: [
      ...
      [/^Tenants who have directed their SwissTrust certificate to (.+)\.$/, (_, agencyName) => `Locataires ayant dirigé leur certificat SwissTrust vers ${agencyName}.`],
    ...
    de: [
      ...
      [/^Tenants who have directed their SwissTrust certificate to (.+)\.$/, (_, agencyName) => `Mieter, die ihr SwissTrust-Zertifikat an ${agencyName} gerichtet haben.`],
    ...
    it: [
      ...
      [/^Tenants who have directed their SwissTrust certificate to (.+)\.$/, (_, agencyName) => `Locatari che hanno indirizzato il loro certificato SwissTrust a ${agencyName}.`],
  ...
  function injectSwitcher() {
    ...
    label.className = 'st-lang-switcher__label';
    label.textContent = 'Language';
    label.setAttribute('for', 'st-language-select');

    const select = document.createElement('select');
    select.id = 'st-language-select';
    select.className = 'st-lang-switcher__select';
